	...
	void* pUserContext)
{
	...
	g_mModelMatrix = XMMatrixScaling(100.0f, 100.0f, 100.0f);
	...
	float fElapsedTime, void* pUserContext)
{
	...
	XMVECTOR vLightDir = 1000*g_LightControl.GetLightDirection();
	...
	float fAmbient = 0.1f;
	XMStoreFloat3(reinterpret_cast<XMFLOAT3*>(&pPerFrame->m_vLightDir), vLightDir);
	pPerFrame->m_vLightDir.w = fAmbient;
